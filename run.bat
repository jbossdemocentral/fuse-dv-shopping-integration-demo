...
start "" "%DV_DIR%\bin\standalone.bat"
	...
	call "%FUSE_DIR%\bin\client.bat" "-h" "127.0.0.1" "-r" "10" "-u" "admin" "-p" "admin"    "osgi:install -s wrap:file:%DV_DIR_OSGI%/dataVirtualization/jdbc/teiid-8.4.1-redhat-7-jdbc.jar"
